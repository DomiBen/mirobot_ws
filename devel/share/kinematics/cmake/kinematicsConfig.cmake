...
if("TRUE" STREQUAL "TRUE")
  set(kinematics_SOURCE_PREFIX /home/dominik/mirobot_ws/src/kinematics)
  set(kinematics_DEVEL_PREFIX /home/dominik/mirobot_ws/devel)
  ...
  set(kinematics_INSTALL_PREFIX /home/dominik/mirobot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dominik/mirobot_ws/src/kinematics/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(kinematics_EXPORTED_TARGETS ${${kinematics_dep}_EXPORTED_TARGETS})
endforeach()
